...
Template.addEstimation.events({
	...
	'submit form': function(e,t) {
		e.preventDefault();
		var geocode = 
			$('.full-address .streetNumber input').val() + ' ' +
			$('.full-address .num-compl').find('option:selected') + ' ' +
			$('.full-address .streetName input').val() + ' ' +
			$('.full-address .complement input').val() + ' ' +
			$('.full-address .zipcode input').val() + ' ' +
			$('.full-address .city input').val() + ' ' +
			$('.full-address .country input').val();
		var data = {
